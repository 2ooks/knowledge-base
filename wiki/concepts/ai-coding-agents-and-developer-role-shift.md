...
- [UNVERIFIED] Devin deployed at Fortune 500 companies for COBOL modernization: automated documentation of millions of lines of legacy code, migration from COBOL to cloud platforms (AWS Lambda), refactoring business logic across hundreds of interdependent modules; addresses three core challenges: COBOL data complexity (copybooks, flat memory, inconsistent naming), LLMs' lack of COBOL training data (mainframe code absent from typical datasets), and workforce crisis (47% cannot fill COBOL roles, 92% of developers retire by 2030); operates as autonomous agent in sandboxed environments with integration to Microsoft Azure, GitHub, and platforms like Infosys Topaz Fabric ([[cognition-devin-cobol-modernization]])
- Enterprise trust barrier for complex engineering: AMD AI Group stopped using Claude Code for demanding engineering tasks after documenting performance regression (superficial context understanding, unauthorized changes, quick fixes over correct solutions); demonstrates enterprise adoption ceiling when agent reliability degrades for multi-file, context-heavy work common in production systems [UNVERIFIED] ([[infoworld-enterprise-claude-code-reliability]])
- Agent evaluation as new developer skill: AMD's quantitative analysis of ~7,000 sessions with 230,000+ tool calls represents emerging skill set—instrumentation, metrics tracking, and systematic reliability assessment becoming core competencies for teams adopting AI coding agents [UNVERIFIED] ([[infoworld-enterprise-claude-code-reliability]])
...
- As agents automate legacy modernization (COBOL → cloud), what happens to the consulting services TAM? Does GitHub/Azure capture revenue that historically went to Accenture/Deloitte/Cognizant/Infosys, or do those firms adopt agent tools and maintain market share?
