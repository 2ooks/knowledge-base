...
- OpenAI's "harness engineering" as named paradigm: internal experiment demonstrated agents handling all code generation (1M LOC product) while humans focus on harness design — environment setup, feedback loops, architectural guardrails, linters/structural tests [UNVERIFIED] ([[openai-harness-engineering]])
