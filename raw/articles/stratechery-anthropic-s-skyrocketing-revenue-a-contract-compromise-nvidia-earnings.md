...
**Source:** https://stratechery.com/2026/anthropics-skyrocketing-revenue-a-contract-compromise-nvidia-earnings/?access_token=eyJhbGciOiJSUzI1NiIsImtpZCI6InN0cmF0ZWNoZXJ5LnBhc3Nwb3J0Lm9ubGluZSIsInR5cCI6IkpXVCJ9..tCS8-FSUL80InxPpwxq0AWuw4nTZrWE_1dsNIAZtBbDcyYp0wAe9rq46Auaex1urlVyoH1IXjqkFAsC0v5cNK1Ls3piPsPW-FrO9sgRu04MuxAgSGsbOKXiCvym8er25v4YIPe8j26CtpOHVGz8lrydtucSdRF0ghu06_dnzhPCxytg69u9cYSTIgxzjsYW79wnxVjJggERL2nf7A7EU615SAzKgddFsqQRGRvp4kZtklcrLtKMop1x7480ozxat41bCYZxam7lFaaxlRRmzcgGZidQLGVON5M_EmGPNUVzQMWG3B0m4mlxO-XJsyTVanpbt8zpnkuFEPBY4ppdgDw
**Date:** 2026-03-04
**Author:** Ben Thompson
...
; the biggest surprise to me is that the RAM pricing stayed the same.
I owe John Gruber a steak dinner
.
On to the Update:
...
To put this number in context, OpenAI said
in January
that it passed $20 billion in annualized revenue in 2025; it seems plausible that Anthropic is actually going to surpass OpenAI, at least if this data from Ramp’s lead economist is any indication. First, Anthropic is, in a head-to-head comparison with OpenAI, dominating API spend:
...
This rapid growth, meanwhile, actually raises the stakes for Anthropic’s standoff with the U.S. government. One of the implications of
what I wrote about yesterday
about technology products addressing markets much larger than the government is that technology products don’t
need
the government; this means that the government can’t really exact that much damage by simply declining to buy a product. That, by extension, means that if the government is determined to control the product in question, it has to use much more coercive means, which raises the specter of much worse outcomes for everyone.
...
this analysis from Under Secretary of State Jeremy Lewin
about the difference between the rejected Anthropic contract and the OpenAI contract pointed to a way forward:
...
Sam Altman and OpenAI have been
in pure damage control mode
...
Wall Street wasn’t impressed; from
Bloomberg
:
...
The second inflection point was the emergence of reasoning models — call this the o1 moment. In this paradigm there are a very large amount of tokens that are generated to figure out the answer
before
the answer is actually generated; this was an exponential increase in the addressable market for tokens.
...
This is why CEO Jensen Huang felt confident that hyperscalers would continue to grow CapEx in 2027 and beyond, even as they plan to spend up to (or beyond) their free cash flow this year; from the question-and-answer section of
the earnings call
:
