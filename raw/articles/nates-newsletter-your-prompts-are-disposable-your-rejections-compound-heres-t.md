...
**Source:** https://natesnewsletter.substack.com/p/the-most-expensive-ai-mistake-isnt
**Date:** March 10, 2026
...
**Scoring reason:** Directly analyzes Microsoft's Copilot Cowork launch with Anthropic models, multi-model strategy, agent platform orchestration, and competitive positioning against Claude Cowork.
...
Why generation is now a commodity.
The GDPval data, the agent reliability gap, and what they mean for where competitive advantage actually lives.
The three dimensions of rejection as a competency.
Recognition, articulation, and encoding, and why almost no one is developing any of them deliberately.
The compounding opportunity nobody has built for.
How encoded rejections create a flywheel, why Epic Systems is the best example, and what the missing infrastructure looks like.
The seed corn problem.
A 67% collapse in entry-level tech hiring is eliminating the pipeline that produces the experts AI depends on, and it can’t be reversed.
What to do about it this week, plus prompts and a guide to start building yours.
Specific actions for executives, managers, individual contributors, and product builders, with a prompt kit that mines your conversation history for the taste you’ve already developed, and an
Open Brain
extension guide that gives your constraints a permanent, queryable home.
...
+
guide
Your taste is already in your conversation history. Every time you corrected AI output, rewrote a draft, or said "not quite," you were encoding a preference you never captured. The Mine Your Taste prompt kit walks you through surfacing those patterns, naming them, and turning them into a portable taste profile you can paste into any AI's system prompt. Five prompts, works with any model, no special setup. If you use
Open Brain
, the companion guide adds a dedicated taste_preferences table to your Supabase in about ten minutes, so your constraints live in a queryable database you can pull from automatically instead of a document you'll eventually lose.
