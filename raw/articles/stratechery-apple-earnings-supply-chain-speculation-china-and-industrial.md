...
**Source:** https://stratechery.com/2026/apple-earnings-supply-chain-speculation-china-and-industrial-design/?access_token=eyJhbGciOiJSUzI1NiIsImtpZCI6InN0cmF0ZWNoZXJ5LnBhc3Nwb3J0Lm9ubGluZSIsInR5cCI6IkpXVCJ9..pAjuV51XVGHUAfSFI8ST5PWQxLGw8_gp7moFDW-raLpVQ-D9kzCYyOZMrtJMw5WKAHhBedrnheGS9JoF89Cq87sMIf3Np6n6Zvnjydvd3ZLVYS3qswr0VuPxQ8rSacCIrc_eljulggWBlvPeJKvvH79WcsmZfSirkZUVpIr7DEwBiEn1_PtR_PzaIo7y_e7w0EXPZV2Z4gEAfBznFG8b25amdRWsxTdvzK1qRQ2VKRnUh8J2IKH9rm1pcOcXis-yBitWKHxwogxYgSdq2LiDDsMJCJcNFHv-mzK6xGZFYExl5de1zfPm6CiMGp31tIUN6p_FFkAZ_UtxK1Kl0UyTjg
**Date:** February 4, 2026
**Author:** Stratechery
**Score:** 4/5 | **Concepts:** ai-agent-ecosystem, agent-security-identity-and-permissions, open-models-and-local-inference
**Scoring reason:** Analyzes autonomous AI agents self-organizing on personal hardware, forming proto-economies, with implications for agent ecosystem governance, security, and local inference.
...
Jon at
Asianometry
has a video response to my
TSMC Risk Article
entitled
Silicon Valley Thinks TSMC is Braking the AI Boom
; he thinks I need to exercise a little patience.
On to the Update:
Apple Earnings
From the
Wall Street Journal
...
There’s no ifs, ands, or buts about it: this was a monster quarter for Apple generally, and the iPhone in particular. What is especially notable is that sales could have been even higher. CEO Tim Cook said
...
It is going to be very interesting to see how Apple navigates the new supply environment. From another article in the
Wall Street Journal
:
...
Back in 2017, I wrote an Article called
Apple’s China Problem
that made the case that the dominance of WeChat in particular meant that iOS as an operating system was less of a differentiator in China than in other markets; this meant that Apple’s competitive position in China was much more precarious and much more dependent on the phone’s industrial design:
