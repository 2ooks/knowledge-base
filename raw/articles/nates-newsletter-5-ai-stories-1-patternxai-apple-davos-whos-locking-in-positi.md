...
**Source:** https://natesnewsletter.substack.com/p/this-week-in-ai-news-xai-got-20b
**Date:** January 24, 2026
**Author:** Nate's Newsletter
**Score:** 4/5 | **Concepts:** inference-architecture-and-scaling, token-economics-and-pricing
**Scoring reason:** Analyzes inference cost curve improvements, multi-modal AI convergence, and the economic dynamics enabling always-on perception systems with falling latency and costs.
...
1
5 AI Stories, 1 Pattern—xAI, Apple, Davos: Who's Locking In Positions (and Who's Too Late)
Never a dull moment, is there? The 5 stories that mattered this week and why the positions getting locked have big implications for where we're heading.
Nate
Jan 24, 2026
∙ Paid
47
...
Sources:
https://www.perplexity.ai/search/build-me-a-complete-report-tha-XakmsXv5RX2CziU6aPnmAQ?preview=1&sm=r#0
Grab the prompt
