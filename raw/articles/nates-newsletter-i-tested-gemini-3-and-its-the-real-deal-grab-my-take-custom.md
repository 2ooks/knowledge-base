# I Tested Gemini 3 And It's The Real Deal: Grab My Take + Custom Prompt to See The Impact on Your Role
**Source:** https://natesnewsletter.substack.com/p/how-gemini-3-changes-your-job-a-practical
**Date:** November 19, 2025
**Author:** Nate's Newsletter
**Score:** 5/5 | **Concepts:** ai-scaling-limits-and-research-paradigm, inference-architecture-and-scaling
**Scoring reason:** Original technical analysis showing RL is doubly inefficient (samples/FLOP and bits/sample) compared to supervised learning, with direct implications for RLVR progress and AI scaling limits.
...
9
I Tested Gemini 3 And It's The Real Deal: Grab My Take + Custom Prompt to See The Impact on Your Role
I put Gemini 3 through its paces and developed the first look at how Gemini 3 is going to shift workflows across the enterprise, plus a custom prompt that explains how to apply it at work today!
Nate
Nov 19, 2025
∙ Paid
91
...
The Gemini 3 Work Prompt
: a paste-and-go prompt that interviews you about your work (and your team, if applicable), maps your workflows, and tells you where Gemini 3, GPT 5.1, Sonnet 4.5, or smaller models actually belong.
Workflows, role-by-role
: a role-by-role draft map across PM, engineering, design, marketing, sales, data, support, and exec workflows. I did the hard work of pulling out the implications of the model and looking at new use-cases Gemini unlocks, plus where it’s not worth the change.
Cost–Benefit & Risk Calculator
: guidance for deciding where Gemini 3 clears the bar (and where it doesn’t)
The Router Era
: Notes on how Gemini 3 changes human work: what “see & do” work shifts to the model, and the specific areas we humans still lead
A Custom 90-Day AI Plan
: the prompt will give you a suggested action plan to roll toward Gemini 3 in a smart way
The “Not Yet” List
: guardrails to keep you from blowing yourself up with early agentic workflows
...
Routing:
decide which workflows go to Gemini vs Claude Sonnet 4.5 vs ChatGPT 5.1 and keep that map up to date.
Supervision:
define how artifacts are reviewed, what “approval” looks like, and what gets logged.
Education:
build shared patterns and prompts so every team doesn’t reinvent the wheel.
