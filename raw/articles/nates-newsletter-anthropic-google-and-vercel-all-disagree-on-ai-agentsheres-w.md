# Anthropic, Google, and Vercel All Disagree on AI Agents—Here's What Really Matters in 8 Minutes, Plus a Custom Prompt to Figure out YOUR Career with AI Agents
**Source:** https://natesnewsletter.substack.com/p/i-summarized-3-ai-agent-papers-60
**Date:** November 17, 2025
**Author:** Nate's Newsletter
**Score:** 4/5 | **Concepts:** open-models-and-local-inference, inference-architecture-and-scaling, gpu-and-compute-economics
**Scoring reason:** Detailed analysis of the emerging open AI inference stack: neoclouds, open-source engines (vLLM, SGLang), open models (DeepSeek, Llama, Qwen), and the enterprise fine-tune-deploy-retrain loop.
...
4
Anthropic, Google, and Vercel All Disagree on AI Agents—Here's What Really Matters in 8 Minutes, Plus a Custom Prompt to Figure out YOUR Career with AI Agents
There's a war brewing over AI agents: a war between idealists and practical builders. I dive into more than 60 pages of AI agent documentation out new this week to get the real story in 8 minutes.
Nate
Nov 17, 2025
∙ Paid
71
...
Subscribed
Get the AI Agent Strategy Prompt
...
Execution proceeds accordingly. The agent calls find_order(”12345”), observes the result (retrieving tracking number “ZYX987”), then calls get_shipping_status(”ZYX987”), observes the result (”Out for Delivery”), and generates the final response: “Your order #12345 is ‘Out for Delivery’!”
...
Looking for more?
Read Google’s whitepaper
Read Vercel’s field report
Read Claude’s post-hack breakdown
Dive further with the Perplexity
