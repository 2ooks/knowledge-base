...
function buildAskPage(navData) {
  ...
  const askContent = [
    ...
    "  var url = 'https://github.com/' + REPO + '/issues/new?template=BLANK&title=' + encodeURIComponent(title) + '&body=' + encodeURIComponent(body) + '&labels=qa';",
    ...
    "  var url = 'https://github.com/' + REPO + '/issues/new?template=BLANK&title=' + encodeURIComponent(title) + '&body=' + encodeURIComponent(BRIEF_BODY) + '&labels=briefing';",
    "  window.open(url, '_blank');",
